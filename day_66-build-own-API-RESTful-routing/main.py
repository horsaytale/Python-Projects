...
def get_all_cafes():
    cafes = db.session.query(Cafe).all()
    return jsonify(cafe=[cafe_info.to_dict() for cafe_info in cafes])
...
# Key in the web tab - http://127/0.0.1:5000/search?loc=Peckham
...
def delete_cafe(cafe_id):
    api_key_value = request.args.get("api-key")
